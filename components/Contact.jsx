    ...
    <div id="contact" className="w-full lg:h-screen lg:pl-4">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          <Fade duration={2000} bottom left>
            <div className="col-span-3 lg:col-span-2 w-full h-full shadow-md shadow-black bg-[#0e0e10] rounded-xl p-4">
              <div className="lg:p-4 w-full">
                <div>
                  <img
                    src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8bGFwdG9wfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                    alt="/"
              ...
              <div>
                ...
                <div className="flex items-center justify-between py-4 p-14">
                  ...
                  <a href="mailto:hilaryokems@gmail.com">
          ...
          <Fade duration={2000} left>
            <div className="col-span-3 w-full h-auto shadow-md shadow-black bg-[#0e0e10] rounded-xl">
              <div className="p-4">
                <form
                  action="https://getform.io/f/ca318b4d-45cc-42a1-ade3-b46122deca17"
                  method="POST"
                >
                  ...
                  <button className="w-full p-4 mt-4 shadow-md shadow-black rounded-xl uppercase bg-gradient-to-r from-[#ff5757] to-[#f899ac] text-gray-100">
                    Send Message
                  </button>
                </form>
              </div>
      ...
      <div className="py-4 bg-[#070708]">
        <div className="flex items-center justify-center">
          ...
          <div>
            <p className="font-bold ml-2 mb-2">
              <small> Okemeziem.S.Hilary All rights reserved.</small>
            </p>
          </div>
        </div>
      </div>
