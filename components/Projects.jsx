            ...
            <div className='grid sm:grid-cols-2 md:hidden gap-8'>
                    ...
                    <div className='h-auto w-full bg-[#0e0e10] rounded-b-xl'>
                        ...
                        <div className='shadow-md shadow-black bg-[#0e0e10] rounded-b-xl p-2'>
                            <div className='flex items-center justify-between'>
                                <h3 className='text-2xl tracking-wider text-white'>Ecommerce Store</h3>
                ...
                <Zoom duration={2000}>
                    <div className='h-auto w-full bg-[#0e0e10] rounded-b-xl'>
                        ...
                        <div className='shadow-md shadow-black bg-[#0e0e10] rounded-b-xl p-2'>
                            <div className='flex items-center justify-between'>
                                <h3 className='text-2xl tracking-wider text-white'>Crypto App</h3>
                                <div className='flex items-center gap-4'>
                ...
                <Fade duration={2000} top left>
                    <div className='h-auto w-full bg-[#0e0e10] rounded-b-xl'>
                        ...
                        <div className='shadow-md shadow-black bg-[#0e0e10] rounded-b-xl p-2'>
                            <div className='flex items-center justify-between'>
                                <h3 className='text-2xl tracking-wider text-white'>Netflix UI clone</h3>
                                <div className='flex items-center gap-4'>
                ...
                <Slide duration={2000} bottom >
                    <div className='h-auto w-full bg-[#0e0e10] rounded-b-xl'>
                        ...
                        <div className='shadow-md shadow-black bg-[#0e0e10] rounded-b-xl p-2'>
                            <div className='flex items-center justify-between'>
                                <h3 className='text-2xl tracking-wider text-white'>Twitch UI clone</h3>
                                <div className='flex items-center gap-4'>
